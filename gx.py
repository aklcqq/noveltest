...
#else:
url = 'https://www.aszw.org/book/384/384455/'
#url = 'https://www.booktxt.net/8_8112/'
...
hthd = '<!DOCTYPE html><html lang="zh-hans"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>归向</title><style>@font-face {font-family: "方正书宋_GBK"; src: url("fonts/FZSSK.TTF")} body {margin-left: calc((100% - 520px)/ 2); max-width: 32.5rem; width: 32.5rem; flex:0 0 auto; flex-grow: 0; flex-shrink: 0; flex-basis: auto; font-family: 方正书宋_GBK, 宋体, 仿宋;}@media screen and (max-width: 600px) {body{max-width:100%;width:98%;margin-left:2%; font-family: 方正书宋_GBK, 宋体, 仿宋;}}</style></head><body>'
htft = '</body></html>'
...
#txtcont = txtcon.get_text()
#outfile = open("fh.html", "w")
#for line in txtcont:
#    outfile.write(line)
#outfile.close()
